        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1.5rem" }}>
          {[
            ...
            <motion.div
              key={i}
              {...fadeUp(i * 0.15)}
              whileHover={{ y: -6, boxShadow: `0 16px 48px rgba(0,0,0,0.35), 0 0 0 1px ${GREEN}44` }}
              transition={{ duration: 0.25 }}
              style={{ background: "rgba(255,255,255,0.04)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "20px", padding: "2rem", boxShadow: "0 8px 32px rgba(0,0,0,0.2)", cursor: "default" }}
            >
