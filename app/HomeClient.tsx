...
const slides = [
  { url: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1800&q=80', eyebrow: 'Island Escapes', title: 'Your Dream', sub: 'Begins Here' },
  { url: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1800&q=80', eyebrow: 'Safari Adventures', title: 'Wild &', sub: 'Unforgettable' },
  { url: 'https://images.unsplash.com/photo-1548574505-5e239809ee19?auto=format&fit=crop&w=1800&q=80', eyebrow: 'Luxury Cruises', title: 'Sail Into', sub: 'Paradise' },
...
const C = {
  cream: '#FDF6EC', sand: '#F5ECD7', gold: '#C49A45', goldDark: '#A07830',
  goldLight: '#E8C87A', teal: '#3A7D7D', tealLight: '#EAF4F4',
    ...
    <div style={{ background: C.cream, overflowX: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 24px', textAlign: 'center' }}>
          <div style={{ maxWidth: 780, width: '100%', paddingBottom: 60 }}>
            <div className="hero-logo-wrap" style={{ opacity: loaded ? 1 : 0, animation: loaded ? 'fadeUp 0.9s ease forwards' : 'none', marginBottom: 24, marginTop: 80 }}>
              <img src="/logo.png" alt="FHJ Dream Destinations" style={{ width: 140, height: 140, objectFit: 'contain', filter: 'drop-shadow(0 4px 24px rgba(196,154,69,0.5))' }} />
            </div>
      ...
      <section className="welcome-split" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        <div className="welcome-left" style={{ background: C.sand, padding: '96px 72px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(30px,3.5vw,54px)', fontWeight: 300, color: C.text, lineHeight: 1.15, marginBottom: 24 }}>
            We don't just book trips.<br /><em style={{ color: C.teal }}>We craft experiences</em><br />you'll carry forever.
          </h2>
          <p style={{ fontSize: 17, color: C.muted, lineHeight: 1.9, marginBottom: 16 }}>FHJ Dream Destinations is a boutique luxury travel team — not a call center, not a booking engine. You'll work directly with our experts who know your name, your style, and exactly what makes a vacation perfect for <em>you</em>.</p>
          <p style={{ fontSize: 17, color: C.muted, lineHeight: 1.9, marginBottom: 36 }}>Whether it's a private safari in the Serengeti, a family cruise through the Caribbean, or a romantic escape to Santorini — we handle every detail with the care you deserve.</p>
        ...
        <div className="welcome-right" style={{ background: C.cream, padding: '96px 72px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          {[
      ...
      <section className="section-pad" style={{ padding: '100px 60px', background: C.sand }}>
        <div style={{ maxWidth: 880, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(28px,4vw,54px)', fontWeight: 300, color: C.text, marginBottom: 56 }}>Real trips. Real <em style={{ color: C.teal }}>memories.</em></h2>
              ...
              <div key={i} style={{ position: 'absolute', inset: 0, opacity: activeT === i ? 1 : 0, transition: 'opacity 0.9s ease', pointerEvents: activeT === i ? 'auto' : 'none' }}>
                <div style={{ background: C.cream, borderRadius: 16, padding: '48px 56px', border: `1px solid rgba(196,154,69,0.2)`, boxShadow: `0 8px 40px rgba(196,154,69,0.1)` }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, flexWrap: 'wrap' }}>
                    ...
                    <div style={{ display: 'flex', gap: 3 }}>{[...Array(5)].map((_, s) => <span key={s} style={{ fontSize: 16, color: C.gold }}>★</span>)}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="section-pad" style={{ padding: '100px 60px', background: C.cream }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            ...
            <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(32px,4vw,58px)', fontWeight: 300, color: C.text }}>Why travelers <em style={{ color: C.teal }}>choose us</em></h2>
          </div>
